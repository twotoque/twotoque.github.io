...
function App(){
  ...
  return <div> 
    ...
    <div className="textBody !mb-0"> 
      ...
      <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-lg text-gray-800 max-w-2xl text-center">
       I currently work at <b>Toronto City Council (Ward 23 – Scarborough North)</b> as a Graphics Communications Assistant, contributing to event engagement and digital design using the Adobe suite, as well as data visualization work using Python. This summer, I will be interning at <b>Mastercard</b> in the <b>Brighterion AI team</b> as a Product Designer. Previously, I also supported founders at Wilfrid Laurier University’s Start-Up Lab through software development and Figma prototyping, as well as have years of experience within the non-profit space.
       </motion.p>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-lg text-gray-800 max-w-2xl text-center">
