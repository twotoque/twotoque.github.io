...
const SectionWithSwatch = ({ projectSections, title, swatchObject}: any) => {
  ...
  return (
    <section>
      ...
      <div className="flex justify-center gap-8 p-8">
        {swatchObject.map((swatch: any, idx: any) => (
          <ColourSwatch
            key={idx}
            title={swatch.title}
            hex_colour={swatch.hex_colour}
            bg_colour={swatch.bg_colour}
          />
        ))}
      </div>
...
export default SectionWithSwatch;
